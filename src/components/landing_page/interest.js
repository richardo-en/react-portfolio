...
const InterestSection = React.forwardRef((props, ref) => {
  ...
  return (
    <section id="interest" className={`context ${ClassShow} grid grid-cols-2 grid-rows-4 lg:grid-cols-3 lg:grid-rows-3 lg:gap-2 sm:mb-32 py-20 sm:py-12`}>
      ...
      {textContent.interestInformation && (
        <>        
        <div className={`slide_left ${ClassShow} row-start-2 col-span-2 sm:col-span-1 pl-3 self-center md:self-end border-solid border-b-2 border-black`}>
        ...
        <div className={`slide_left ${ClassShow} row-start-4 col-span-2 lg:row-start-3 lg:col-start-2 sm:col-start-1 pr-3 lg:ml-32 border-solid ml-5 border-l-2 border-black lg:border-extrawhite lg:mt-32 h-40 xl:self-end`}>
